...
class VisableSpace extends Space implements Visable {
	...
	static {
		image_4x4 = ImageManager.getImage ("4x4/org.cs.Space.gif");
		image_8x8 = ImageManager.getImage ("8x8/org.cs.Space.gif");
	}

	public VisableSpace (GameManager manager, GameSpaceCanvas space) {
                super (manager);
		this.space = space;
        }

	public VisableSpace (int x, int y, GameManager manager, GameSpaceCanvas space) {
                super (x, y, manager);
		this.space = space;
        }
	...
	public Image getImage (int cellSize) {
		...
		case 4:
			return image_4x4;
		default:
			System.err.println ("org.cs.VisableSpace: unsupported cell size.");
			System.exit (1);
		}
		// not reached
		return null;
