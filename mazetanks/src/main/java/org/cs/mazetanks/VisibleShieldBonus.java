...
class VisibleShieldBonus extends ShieldBonus implements Visible {
    protected static Image image_4x4, image_8x8;

    static {
        image_4x4 = ImageManager.getImage("4x4/ShieldBonus.gif");
        image_8x8 = ImageManager.getImage("8x8/ShieldBonus.gif");
    }
    ...
    public VisibleShieldBonus(int x, int y, int count, GameManager manager, GameSpaceCanvas space) {
        super(x, y, count, manager);
        this.space = space;
    }

    public VisibleShieldBonus(int x, int y, GameManager manager, GameSpaceCanvas space) {
        super(x, y, manager);
        this.space = space;
    }
    ...
    public Image getImage(int cellSize) {
        switch (cellSize) {
            ...
            case 4:
                return image_4x4;
            default:
                System.err.println("VisibleShieldBonus: unsupported cell size.");
                System.exit(1);
        }
        // not reached
        return null;
