...
class VisableNukeBulletBonus extends NukeBulletBonus implements Visable {
	...
	static {
		image_4x4 = ImageManager.getImage ("4x4/org.cs.NukeBulletBonus.gif");
		image_8x8 = ImageManager.getImage ("8x8/org.cs.NukeBulletBonus.gif");
	}

	public VisableNukeBulletBonus (int x, int y, int count, GameManager manager, GameSpaceCanvas space) {
                super (x, y, count, manager);
		this.space = space;
        }

	public VisableNukeBulletBonus (int x, int y, GameManager manager, GameSpaceCanvas space) {
                super (x, y, manager);
		this.space = space;
        }
	...
	public Image getImage (int cellSize) {
		...
		case 4:
			return image_4x4;
		default:
			System.err.println ("org.cs.VisableNukeBulletBonus: unsupported cell size.");
			System.exit (1);
		}
		// not reached
		return null;
