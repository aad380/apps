...
class VisableBigBullet extends BigBullet implements Visable {
	...
	public VisableBigBullet (int x, int y, int direction, GameManager manager, Player player, GameSpaceCanvas space) {
	...
	public Image getImage (int cellSize) {
		...
		default:
			System.err.println ("org.cs.VisableBigBullet: unsupported cell size.");
			System.exit (1);
		}
		// not reached
		return null;
