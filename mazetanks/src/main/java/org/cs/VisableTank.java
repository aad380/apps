...
class VisableTank extends Tank implements Visable {
	...
	static {
		images_4x4 [UP_DIRECTION] = ImageManager.getImage ("4x4/Tank_u.gif");
		images_4x4 [RIGHT_DIRECTION] = ImageManager.getImage ("4x4/Tank_r.gif");
		images_4x4 [DOWN_DIRECTION] = ImageManager.getImage ("4x4/Tank_d.gif");
		images_4x4 [LEFT_DIRECTION] = ImageManager.getImage ("4x4/Tank_l.gif");
		images_8x8 [UP_DIRECTION] = ImageManager.getImage ("8x8/Tank_u.gif");
		images_8x8 [RIGHT_DIRECTION] = ImageManager.getImage ("8x8/Tank_r.gif");
		images_8x8 [DOWN_DIRECTION] = ImageManager.getImage ("8x8/Tank_d.gif");
		images_8x8 [LEFT_DIRECTION] = ImageManager.getImage ("8x8/Tank_l.gif");
	}

	public VisableTank (int x, int y, int direction, GameManager manager, Player player, GameSpaceCanvas space) {
	...
	public Image getImage (int cellSize) {
		...
		default:
			System.err.println ("org.cs.VisableTank: unsupported cell size.");
			System.exit (1);
		}
		// not reached
		return null;
