...
class VisableBulletBonus extends BulletBonus implements Visable {
	...
	static {
		image_4x4 = ImageManager.getImage ("4x4/org.cs.BulletBonus.gif");
		image_8x8 = ImageManager.getImage ("8x8/org.cs.BulletBonus.gif");
	}

	public VisableBulletBonus (int x, int y, int count, GameManager manager, GameSpaceCanvas space) {
                super (x, y, count, manager);
		this.space = space;
        }

	public VisableBulletBonus (int x, int y, GameManager manager, GameSpaceCanvas space) {
                super (x, y, manager);
		this.space = space;
        }
	...
	public Image getImage (int cellSize) {
		...
		case 4:
			return image_4x4;
		default:
			System.err.println ("org.cs.VisableBulletBonus: unsupported cell size.");
			System.exit (1);
		}
		// not reached
		return null;
