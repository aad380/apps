...
class VisableBigBulletBonus extends BigBulletBonus implements Visable {
	...
	static {
		image_4x4 = ImageManager.getImage ("4x4/org.cs.BigBulletBonus.gif");
		image_8x8 = ImageManager.getImage ("8x8/org.cs.BigBulletBonus.gif");
	}

	public VisableBigBulletBonus (int x, int y, int count, GameManager manager, GameSpaceCanvas space) {
                super (x, y, count, manager);
		this.space = space;
        }

	public VisableBigBulletBonus (int x, int y, GameManager manager, GameSpaceCanvas space) {
                super (x, y, manager);
		this.space = space;
        }
	...
	public Image getImage (int cellSize) {
		...
		case 4:
			return image_4x4;
		default:
			System.err.println ("org.cs.VisableBigBulletBonus: unsupported cell size.");
			System.exit (1);
		}
		// not reached
		return null;
