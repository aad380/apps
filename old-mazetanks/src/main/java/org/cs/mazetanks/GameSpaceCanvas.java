...
public class GameSpaceCanvas extends Canvas implements GameSpace {
    ...
    public GameSpaceCanvas(int width, int height, int cellSize, Color wallColor, Color spaceColor) {
        super();
    ...
    void moveWindow(int dx, int dy) {
        ...
        if (dy == 0) {
            if (dx == 1) {
                ...
                System.err.println("GameSpaceCanvas: moveWindow: bad parameters");
                System.exit(1);
            }
        } else if (dx == 0) {
            if (dy == 1) {
    ...
    public void start() {
        if (mainObject == null) {
            System.err.println("GameSpaceCanvas: start when mainObject is not defined.");
            System.exit(1);
        } else if (maze == null) {
            System.err.println("GameSpaceCanvas: start when maze is not defined.");
            System.exit(1);
        }
    ...
    public void setMaze(GameMaze maze) {
        if (started) {
            System.err.println("GameSpaceCanvas: maze addad when started.");
            System.exit(1);
        }
        this.maze = maze;
        width = maze.getWidth();
    ...
    public void setMainObject(GameObject object) {
        if (started) {
            System.err.println("GameSpaceCanvas: attemnpt to setMainObject when SameSpace is started.");
            System.exit(1);
        } else if (maze == null) {
            System.err.println("GameSpaceCanvas: attempt to steMainObject when maze is not defined.");
            System.exit(1);
        } else if (mainObject != null) {
            System.err.println("GameSpaceCanvas: attempt to setMainObject when mainObject is defined.");
            System.exit(1);
        }
    ...
    public int getWidth() {
        if (maze == null) {
            System.err.println("GameSpaceCanvas: attept to getWidth when maze is not defined.");
            System.exit(1);
        }
        return width;
    }
    ...
    public boolean isSpace(int x, int y) {
        if (maze == null) {
            System.err.println("GameSpaceCanvas: attept to isSpace when GameSpace is not defined.");
            System.exit(1);
        }
    ...
    public GameObject getObject(int x, int y) {
        if (maze == null) {
            System.err.println("GameSpaceCanvas: attept to getObject when GameSpace is not defined.");
            System.exit(1);
        }
