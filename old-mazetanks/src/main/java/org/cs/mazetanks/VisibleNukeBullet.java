...
class VisibleNukeBullet extends NukeBullet implements Visible {
    ...
    public VisibleNukeBullet(int x, int y, int direction, GameManager manager, Player player, GameSpaceCanvas space) {
    ...
    public Image getImage(int cellSize) {
        switch (cellSize) {
            ...
            default:
                System.err.println("VisibleNukeBullet: unsupported cell size.");
                System.exit(1);
        }
        // not reached
        return null;
