...
class VisibleWall extends Wall implements Visible {
    ...
    static {
        image_4x4_100 = ImageManager.getImage("4x4/Wall.gif");
        image_8x8_100 = ImageManager.getImage("8x8/Wall.gif");
    ...
    public VisibleWall(int x, int y, GameManager manager, GameSpaceCanvas space) {
        super(x, y, manager);
        this.space = space;
    ...
    public Image getImage(int cellSize) {
        switch (cellSize) {
            ...
            case 4:
                return image_4x4;
            default:
                System.err.println("VisibleWall: unsupported cell size.");
                System.exit(1);
        }
        // not reached
        return null;
